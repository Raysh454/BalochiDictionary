...
import { searchDictionary, type DictionaryResult } from '../lib/searchClient'
...
<template>
  <section>
    <form class="controls" @submit.prevent="search">
      <input v-model="data.keyword" type="text" class="input flex-grow" placeholder="Enter keyword..." />
      <input v-model.number="data.limit" type="number" class="input short" placeholder="Limit" min="1" />
